...
class World:
    def __init__(self):
        ...
        block_id = p.loadURDF("a6b_r.urdf", [0, 0, 0.05])
        ...
        block_id = p.loadURDF("a6b_g.urdf", [0, 0, 0.05])
        p.changeDynamics(block_id, -1, mass=0.8, lateralFriction=0.89)
        ...
        block_id = p.loadURDF("a6b_b.urdf", [0, 0, 0.05])
        p.changeDynamics(block_id, -1, mass=0.8, lateralFriction=0.89)
        ...
        block_id = p.loadURDF("a6b_box.urdf", [0, 0, 0.05])
        p.changeDynamics(block_id, -1, mass=0.8, lateralFriction=0.89)
        ...
        fix_id = p.loadURDF("a6b_fixture.urdf", pos_fix, useFixedBase=1)
